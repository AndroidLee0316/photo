...
import com.pasc.lib.widget.MoreGesturePhotoView;
import com.pasc.lib.widget.photoview.OnOutsidePhotoTapListener;
...
public class PhotoViewPager extends ViewPager {
    ...
    class PhotoPagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            GlideUtil.loadImage(container.getContext(), photoView, picUrl.get(position),
                    R.drawable.pasc_ic_accessory, R.drawable.pasc_ic_accessory);
