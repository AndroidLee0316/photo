...
//        return uris;
//    }
    public static ArrayList<Uri> convertImageToUri(Context context, ArrayList<String> images) throws TException {
        ArrayList<Uri> uris = new ArrayList();
...
//        return tImages;
//    }
    public static ArrayList<TImage> getTImagesWithImages(ArrayList<String> images, TImage.FromType fromType) {
        ArrayList<TImage> tImages = new ArrayList();
        for (String image : images) {
